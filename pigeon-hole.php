  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <nav class="navbar box">
        <a class="nav-item nav-link text-white" href="#"><i class="fa fa-wrench"></i>&nbsp;Pigeon Hole</a>
        <div class="ml-auto">
          <a class="btn btn-light" href="view-pigeon-hole-details.php">View Records</a>
        </div>
      </nav>
      <br/>
          ...
          <tr>
            ...
            <td>
              <div class="form-group">
                ...
                <input type="text" name="fg_no" id="fg_no" class="form-control"  placeholder="FG No" readonly="" required="">
              </div>
            </td>
          </tr>
          <tr>
            <td>
              <div class="form-group">
                ...
                <input type="text" name="seq_no" id="seq_no" class="form-control"  placeholder="Sequence Number" readonly="" required="">
              </div>
            </td>
            <td>
              <div class="form-group">
                <label>FG Part No</label>
                <input type="text" name="po_no" id="po_no" class="form-control"  placeholder="Production Order Number" readonly="" required="">
              </div>
            </td>
          </tr>
          <tr>
            <td>
              <div class="form-group">
                ...
                <input type="text" name="customer" id="customer" class="form-control"  placeholder="Customer" readonly="" required="">
              </div>
            </td>
            <td>
              <div class="form-group">
                <label>Pump Type</label>
                <input type="text" name="pump_type" id="pump_type" class="form-control"  placeholder="Pump Type" readonly="" required="">
              </div>
            </td>
          </tr>
          <tr>
            <td>
              <div class="form-group">
                ...
                <input type="text" name="operator_name" value="<?php echo $_SESSION['name']; ?>" class="form-control"  placeholder="Operator Name" readonly="" required="">
              </div>
            </td>
            <td>
              <div class="form-group">
                <label>TPI</label>
                <input type="text" name="tpi" id="tpi" class="form-control" readonly="" required="">
      ...
      $('#pump_sno').change(function()
      {
        var pump_sno=$('#pump_sno').val();
          $.ajax({
              url: "get-details.php",
              type:"POST",
              data:{pump_sno:pump_sno,key:'147',flag:''},
              success: function(result){
