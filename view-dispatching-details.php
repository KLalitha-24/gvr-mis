   ...
   <!--  </div>
    <div class="col-sm-9"> -->
      ...
      <nav class="navbar box">
        <a class="nav-item nav-link text-white" href="packing.php"><i class="fa fa-wrench"></i>&nbsp;View Dispatching Details</a>
      </nav>
    ...
    <div class="col-sm-12 bg-white box">
      ...
      <div class="row">
        <div class="col-sm-4">
            <h5 class="pl-4">Dispatching Records</h5>
        </div>
        <div class="col-sm-4">
      ...
      <div class="table-responsive p-4" id="res_table">
        ...
        <table class="table" id="dispatching-table">
          ...
          <?php
          include 'db.php';
          $sql="SELECT dispatching.pump_sno AS pump_sno,dispatching.date AS date1,dispatching.time AS time,dispatching.shift AS shift,master_scheduling.fg AS fg_no,master_scheduling.seq_no AS sequence_no,master_scheduling.fg_part_no AS production_order_no,master_scheduling.customer AS customer,master_scheduling.tpi AS tpi,master_scheduling.type AS pump_type,dispatching.operator_name AS operator_name,dispatching.invoice_no AS invoice_no,dispatching.vehicle_no AS vehicle_no from dispatching INNER JOIN master_scheduling ON master_scheduling.serial_no=dispatching.pump_sno";
   ...
   $('#report_frm').submit(function(e)
      {
        e.preventDefault();
          ...
          $.ajax({
              url: "get-dispatching-dynamic-report.php",
              type:"POST",
   ...
   $(document).on('click','#print-graph-btn',function()
      {
          ...
          $("#dispatching-table").table2excel({
            filename: "Dispatching.xls"
        });
