  ...
  <div class="row">
    ...
    <div class="col-sm-9"> -->
      ...
      <nav class="navbar box">
        <a class="nav-item nav-link text-white" href="pigeon-hole.php"><i class="fa fa-wrench"></i>&nbsp;View Pigeon Hole Details</a>
      </nav>
    ...
    <div class="col-sm-12 bg-white box">
      ...
      <div class="row">
        <div class="col-sm-4">
            <h5 class="pl-4">Pigeon Hole Records</h5>
        </div>
        <div class="col-sm-4">
   ...
   $('#report_frm').submit(function(e)
      {
        e.preventDefault();
          ...
          $.ajax({
              url: "get-pigeon-hole-dynamic-report.php",
              type:"POST",
   ...
   $(document).on('click','#print-graph-btn',function()
      {
          ...
          $("#pigeon_hole_table").table2excel({
            filename: "Pigeon Hole.xls"
        });
