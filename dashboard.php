  ...
  <div class="row">
    ...
    <div class="col-sm-9"> -->
      ...
      <nav class="navbar box">
        ...
        <div class="ml-auto">
          <a class="btn btn-light" href="detailed-dashboard.php?date=<?php echo date("Y-m-d"); ?>">Detailed Dashboard</a>
      ...
      <div class="col-sm-12 box bg-white" >
        <div class="row p-2">
          ...
          <?php
          $sql="SELECT type FROM master_scheduling group by type";
          $date=$_GET['date'];
            ...
            while($row=mysqli_fetch_array($res))
            {
              ...
              <tr>
                ...
                <td>
                  ...
                  // echo $dm_month;
                  $sql_d_plan="SELECT COUNT(type) as type FROM master_scheduling WHERE type='".$row['type']."' AND month='".$dm_month."' AND year='".$year."' AND date<='$date'";
                  $row_d_plan=mysqli_fetch_array(mysqli_query($con,$sql_d_plan));
                  echo $row_d_plan['type'];
                  $total_d_plan+=$row_d_plan['type'];
                  ?>
                </td>
                <td>
                  <?php
                  $sql_a_plan="SELECT COUNT(master_scheduling.type) as final_2_count from master_scheduling INNER JOIN final_2 ON master_scheduling.serial_no=final_2.pump_sno WHERE master_scheduling.type='".$row['type']."' AND final_2.month='".$dm_month."' AND final_2.year='".$year."' AND final_2.date<='$date'";
                ...
                <td>
                  ...
                  $sql_d_mtd_plan="SELECT COUNT(type) as type FROM master_scheduling WHERE type='".$row['type']."' AND month='".$dm_month."' AND year='".$year."' AND date<='$date'";
                  $row_d_mtd_plan=mysqli_fetch_array(mysqli_query($con,$sql_d_plan));
                  echo $row_d_mtd_plan['type'];
                  $total_d_mtd_plan+=$row_d_mtd_plan['type'];
                  ?>
                </td>
                <td>
                  <?php
                  ...
                  $sql_a_mtd_plan="SELECT COUNT(master_scheduling.type) as final_2_count from master_scheduling INNER JOIN final_2 ON master_scheduling.serial_no=final_2.pump_sno WHERE master_scheduling.type='".$row['type']."' AND final_2.month='".$dm_month."' AND final_2.year='".$year."' AND final_2.date<='$date'";
                ...
                <td>
                  <?php echo $row_d_mtd_plan['type']-$row_a_mtd_plan['final_2_count']; ?>
                </td>
                <td>
                  <?php 
            
                  $sql_month_plan="SELECT SUM(plan) AS plan FROM monthly_plan WHERE month='".$dm_month."' AND type='".$row['type']."' AND date<='$date' AND year='$year'";
                ...
                <td>
                      ...
                      <?php
                      $sql_sfg_plan="SELECT COUNT(final_2.pump_sno) as final_2_count from final_2 INNER JOIN master_scheduling ON master_scheduling.serial_no=final_2.pump_sno WHERE final_2.date='".$date."' and master_scheduling.type='".$row['type']."'";
                ...
                <td>
                    <?php
                        $sql_sfg_c_plan="SELECT COUNT(final_2.pump_sno) as final_2_count from final_2 INNER JOIN master_scheduling ON master_scheduling.serial_no=final_2.pump_sno WHERE final_2.month='".$dm_month."' AND final_2.year='".$year."' AND final_2.date<='".$date."' and master_scheduling.type='".$row['type']."'";
                  ...
                  <td>
                        <?php
                        $sql_fg_plan="SELECT COUNT(packing.pump_sno) as packing_count from packing INNER JOIN master_scheduling ON master_scheduling.serial_no=packing.pump_sno WHERE packing.date='".$date."' and master_scheduling.type='".$row['type']."'";
                  ...
                  <td>
                        <?php
                        $sql_fg_c_plan="SELECT COUNT(packing.pump_sno) as packing_count from packing INNER JOIN master_scheduling ON master_scheduling.serial_no=packing.pump_sno WHERE packing.month='".$dm_month."' AND packing.year='".$year."'  AND packing.date<='".$date."' and master_scheduling.type='".$row['type']."'";
                ...
                <td>
                  <?php
                  $sql_dispatch_plan="SELECT COUNT(dispatching.pump_sno) as dispatch_count from dispatching INNER JOIN master_scheduling ON master_scheduling.serial_no=dispatching.pump_sno WHERE dispatching.date='".$date."' and master_scheduling.type='".$row['type']."' ";
                ...
                <td>
                  <?php
                  $sql_dispatch_c_plan="SELECT COUNT(dispatching.pump_sno) as dispatch_count from dispatching INNER JOIN master_scheduling ON master_scheduling.serial_no=dispatching .pump_sno WHERE dispatching.month='".$dm_month."' and master_scheduling.type='".$row['type']."' AND dispatching.year='".$year."'  AND dispatching.date<='".$date."'";
                ...
                <td>
                  <?php
                  $sql_t_sidetrack_plan="SELECT COUNT(siron.pump_sno) as count from siron INNER JOIN master_scheduling ON siron.pump_sno=master_scheduling.serial_no WHERE  siron.date<='".$date."'  AND master_scheduling.month='".$dm_month."'  AND master_scheduling.year='".$year."' and master_scheduling.type='".$row['type']."'";
                  $row_t_sidetrack_plan=mysqli_fetch_array(mysqli_query($con,$sql_t_sidetrack_plan));
                  // echo "Total:".$row_t_sidetrack_plan['count']."<br/>";
                  $sql_a_sidetrack_plan="SELECT COUNT(siron.pump_sno) as count from siron INNER JOIN master_scheduling ON siron.pump_sno=master_scheduling.serial_no WHERE siron.approved_date<='".$date."' AND master_scheduling.month='".$dm_month."'  AND master_scheduling.year='".$year."' and master_scheduling.type='".$row['type']."'";
                  $row_a_sidetrack_plan=mysqli_fetch_array(mysqli_query($con,$sql_a_sidetrack_plan));
                  // echo "Cleared:".$row_a_sidetrack_plan['count']."<br/>";
                  $sql_r_sidetrack_plan="SELECT COUNT(siron.pump_sno) as count from siron INNER JOIN master_scheduling ON siron.pump_sno=master_scheduling.serial_no WHERE siron.reject_date<='".$date."' AND master_scheduling.month='".$dm_month."'  AND master_scheduling.year='".$year."' and master_scheduling.type='".$row['type']."'";
