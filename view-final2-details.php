   ...
   <!--  </div>
    <div class="col-sm-9"> -->
      ...
      <nav class="navbar box">
        <a class="nav-item nav-link text-white" href="final-2.php"><i class="fa fa-wrench"></i>&nbsp;View Final 2 Details</a>
      </nav>
    ...
    <div class="col-sm-12 bg-white box">
      ...
      <div class="row">
        <div class="col-sm-4">
            <h5 class="pl-4">Final 2 Records</h5>
        </div>
        <div class="col-sm-4">
      ...
      <div class="table-responsive p-4" id="res_table">
        ...
        <table class="table" id="final-2-table">
          ...
          <?php
          include 'db.php';
          $sql="SELECT final_2.pump_sno AS pump_sno,final_2.date AS date,final_2.time AS time,final_2.shift AS shift,master_scheduling.fg AS fg_no,master_scheduling.seq_no AS sequence_no,master_scheduling.fg_part_no AS production_order_no,master_scheduling.customer AS customer,master_scheduling.type AS pump_type,final_2.operator_name AS operator_name from final_2 INNER JOIN master_scheduling ON master_scheduling.serial_no=final_2.pump_sno";
   ...
   $('#report_frm').submit(function(e)
      {
        e.preventDefault();
          ...
          $.ajax({
              url: "get-final2-dynamic-report.php",
              type:"POST",
   ...
   $(document).on('click','#print-graph-btn',function()
      {
          ...
          $("#final-2-table").table2excel({
            filename: "Final 2.xls"
        });
