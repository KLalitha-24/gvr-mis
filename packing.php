  ...
  <div class="row">
    ...
    <div class="col-sm-9"> -->
      ...
      <nav class="navbar box">
        <a class="nav-item nav-link text-white" href="#"><i class="fa fa-wrench"></i>&nbsp;Packing</a>
        <div class="ml-auto">
          <a href="view-packing-details.php" class="btn btn-light">View Records</a>
        </div>
      </nav>
      <br/>
    ...
    <div class="col-sm-12 box bg-white">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <?php
          include 'db.php';
          $sql="SELECT packing.pump_sno AS pump_sno,packing.date AS date1,packing.time AS time,packing.shift AS shift,master_scheduling.fg AS fg_no,master_scheduling.seq_no AS sequence_no,master_scheduling.fg_part_no AS production_order_no,master_scheduling.customer AS customer,master_scheduling.type AS pump_type,master_scheduling.tpi AS tpi,packing.operator_name AS operator_name from packing INNER JOIN master_scheduling ON master_scheduling.serial_no=packing.pump_sno ORDER BY packing.id DESC LIMIT 10";
      ...
      $('#pump_sno').change(function()
      {
        var pump_sno=$('#pump_sno').val();
          $.ajax({
              url: "get-details.php",
              type:"POST",
              data:{pump_sno:pump_sno,key:'147',flag:'3'},
              success: function(result){
